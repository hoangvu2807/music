        ...
        <nav class="second-nav navbar-expand-lg " >
            <div class="container">
                    <ul class="navbar-nav  ">
                            ...
                            <li class="nav-item">
                              <a class="nav-link text-secondary" href="quanlybaihat.php">Quản Lý Bài Hát</a>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3" >
                            <div class="card" style="padding-top: 10px;padding-left: 15px;">
                                    ...
                                    <div class="card-title">
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="/admin/?theloai=Viet">Hôm Nay Nghe Gì?</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Viet">Love Songs</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Au">Nhạc Quốc Tế</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Viet">Nhạc Giáng Sinh</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Rap">Nhạc Hot Rap Việt</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Viet">Nhạc Hot Việt</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Viet">Nhạc Sàn</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Viet">Nhạc Việt Mới</a></li>
                                                    <li class="list-group-item"><a href="/admin/?theloai=Han">Nhạc Hàn Quốc</a></li>
                                                </ul>
                                    </div>
                            ...
                            <div class="card" style="padding-top: 10px;padding-left: 15px; margin-top: 10px;">
                                    ...
                                    <div class="card-title">
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><a href="/admin/?casy=mtp">Sơn Tùng MTP</a></li>
                                                    <li class="list-group-item"><a href="/admin/?casy=phuc">Đức Phúc</a></li>
                                                    <li class="list-group-item"><a href="/admin/?casy=noo">Noo Phước Thịnh</a></li>
                                                    <li class="list-group-item"><a href="/admin/?casy=AP">Quân AP</a></li>
                                                    <li class="list-group-item"><a href="/admin/?casy=911">911</a></li>
                                                    <li class="list-group-item"><a href="/admin/?casy=bang">Big Bang</a></li>
                                                    <li class="list-group-item"><a href="/admin/?casy=blackpink">BlackPink</a></li>
                    ...
                    <div class="col-lg-6  ">
                        ...
                        if (isset($_GET["theloai"])){
                                $theloai = $_GET["theloai"];
                                $pagLink = '<li class=" page-item mr-2 ' . $class . '"><a class= "page-link" href="/admin/?theloai='.$theloai.'&page=' . ($page - 1 ) . '">Previous</a></li>';
                        }
                        elseif (isset($_GET["casy"])){
                                ...
                                $pagLink = '<li class=" page-item mr-2 ' . $class . '"><a class= "page-link" href="/admin/?page=' . ($page - 1 ) . '">Previous</a></li>';
                        }
                        ...
                        for ($i = $start ; $i <= $end; $i++ ) {  
                                ...
                                if (isset($_GET["theloai"])){
                                        $theloai = $_GET["theloai"];
                                        $pagLink .= "<li class='page-item mr-2 ".$class."'><a class='page-link' href='/admin/?theloai=".$theloai."&page=".$i."'>". $i . "</a></li>";
                                        
                                }
                                elseif (isset($_GET["casy"])){
                                        $theloai = $_GET["casy"];
                                        $pagLink .= "<li class='page-item mr-2 ".$class."'><a class='page-link' href='/admin/?casy=".$theloai."&page=".$i."'>". $i . "</a></li>";
                                        
                                }
                                else{
                                        $pagLink .= "<li class='page-item mr-2 ".$class."'><a class='page-link' href='/admin/?&page=".$i."'>". $i . "</a></li>";
                                }
                        ...
                        if (isset($_GET["theloai"])){
                                $theloai = $_GET["theloai"];
                                $pagLink .= '<li class=" page-item mr-2 ' . $class . '"><a class= "page-link" href="/admin/?theloai='.$theloai.'&page=' . ($page + 1 ) . '">Next</a></li>';
                        }
                        elseif (isset($_GET["casy"])){
                                $theloai = $_GET["casy"];
                                $pagLink .= '<li class=" page-item mr-2 ' . $class . '"><a class= "page-link" href="/admin/?theloai='.$theloai.'&page=' . ($page + 1 ) . '">Next</a></li>';
                                ...
                                $pagLink .= '<li class=" page-item mr-2 ' . $class . '"><a class= "page-link" href="/admin/?page=' . ($page + 1 ) . '">Next</a></li>';
                        }
                        echo $pagLink;  
                        $conn->close();
                        ?>       
                                                ...
                                                <?php 
		                                                ...
		                                                <?php echo $i;?></div>
                                                                <div class="x_2">
                                                                        ...
                                                                        <a  class = "singer"><?php echo $row['casy']; ?></a>
                                                                </div>
